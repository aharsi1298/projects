...
label = Label(root, text="Assigning Jobs", font=("Arial", 20, "bold"), fg="black")
...
class parent():
    ...
    def chemicalEngineer(chemical_engineer_name):
        company_list = ["BASF", "Sinopec", "Dow", "Ineos", "Sabic", "Formosa Plastic", "LG Chem", "Mitsubishi Chemical", "Linde", "LyondellBasell Industries"]
